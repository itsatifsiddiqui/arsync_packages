...
part of 'persistent_auth_provider.dart';
...
mixin _$PersistentAuthState {
  ...
  $PersistentAuthStateCopyWith<PersistentAuthState> get copyWith =>
...
/// @nodoc
class _$PersistentAuthStateCopyWithImpl<$Res, $Val extends PersistentAuthState>
    implements $PersistentAuthStateCopyWith<$Res> {
  _$PersistentAuthStateCopyWithImpl(this._value, this._then);
...
class _$PersistentAuthStateImpl implements _PersistentAuthState {
  ...
  @override
  String toString() {
    return 'PersistentAuthState(isLoading: $isLoading, isAuthenticated: $isAuthenticated, error: $error)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PersistentAuthStateImpl &&
